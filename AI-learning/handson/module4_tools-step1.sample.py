#!/usr/bin/python
"""
Module 4: ツール利用 — Step 1: Function Calling 基本 解答例
"""
import json
import textwrap
    ...
    tools = [
        {
            ...
            # Step 1 解答例: 「何を」「いつ」「いつ使わないか」の3点を含む説明
            "description": (
        ...
        for output in response.output:
            if output.type == "function_call":
                ...
                if output.name == "search_axxx_group_documents":
                    ...
                    # Step 2 解答: args["search_query"] でキーを指定して取り出す
                    ...
                    # Step 3 解答: function_call_output を messages に追加
                    messages.append({
