...
def main(inputs: Optional[list[str]], model: str, dimensions: Optional[int]) -> None:
    ...
    # ══════════════════════════════════════════════════════════════
    # Step 1: Embeddings API を呼び出して埋め込み表現を取得しましょう
    # ヒント: client.embeddings.create(**params) を使ってください
    # ══════════════════════════════════════════════════════════════
    embeddings = None  # EDIT HERE!

    # Step 2: 取得した embeddings オブジェクトを print してみましょう
    # ヒント: embeddings.data[i].embedding がベクトル、embeddings.model でモデル名が確認できます
    # EDIT HERE!
